...
public class SpiderJobContext extends SpiderContext {
     ...
     * @return
     */
    public static SpiderJobContext create(String directory, String name, String id, Integer taskId, boolean output) {
        OutputStream os = null;
        try {
            File file = new File(new File(directory), name + File.separator + "logs" + File.separator + taskId + ".log");
