...
import org.spiderflow.core.io.PostHttpRequest;
        ...
        for (int i = 0; i < retryCount && !successed; i++) {
            ...
            if ("raw".equals(bodyType)) {
                ...
                if ("application/json".equalsIgnoreCase(contentType)) {
                    request.mediaType(PostHttpRequest.JSON);
                } else {
                    request.mediaType(PostHttpRequest.TEXT);
                }
                try {
                ...
                request.mediaType(PostHttpRequest.FORM_DATA);
                ...
                request.mediaType(PostHttpRequest.FORM_URLENCODED);
                //设置请求参数
